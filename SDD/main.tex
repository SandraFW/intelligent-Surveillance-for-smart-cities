...
ISS             & \begin{tabular}[c]{@{}l@{}} It stands for \\ Inteligent Surveillance System\end{tabular} \\ \hline

Deep Learning         & \begin{tabular}[c]{@{}l@{}} Is a subfield of machine learning \\ concerned with algorithms  \end{tabular} \\ \hline

Archive          & \begin{tabular}[c]{@{}l@{}} Stores data that's no\\  longer  day to day use. \end{tabular} \\ \hline

Backup          & \begin{tabular}[c]{@{}l@{}} Designed for rapid \\ recovery of \\ operational data. \end{tabular} \\ \hline
