...
\hline
Test Case ID & Test Case Desc & Functional Req Code & Test Data & Expected Result \\ \hline
TC01  & Admin creates, for a user, an account that already exists & FR10 & string   & new account is not added and an alert message appears               \\ \hline
TC02 & Admin enters wrong data format   & FR10    &  string      &  validation messages appear         \\ \hline
TC03 & Admin enters correctly formatted data   & FR10    &  string      &  a new account got created         \\ \hline
